...
class Solution:
    def longestConsecutive(self, nums):
        ...
        for num in nums:
            ...
            min_num = consecutive_dict[last_num][0] if last_num in consecutive_dict else num
            max_num = consecutive_dict[next_num][1] if next_num in consecutive_dict else num
